        ...
        return (
            <Box sx={{ width: "78px", height: "110px", display: "flex", mx: "0px" }}>
                <Box sx={{ mr: 0.3, backgroundColor: "#fff", width: "76px", height: "78px", display: "grid", gridTemplateColumns: "1fr 1fr" }}>
                    ...
                    <Box sx={{ backgroundColor: "secondary.superlight", width: "39px", height: "29px", textAlign: "center", pt: "10px", borderLeft: "1px solid #1c1c1c", borderBottom: "1px solid #1c1c1c", borderRight: "1px solid #1c1c1c", borderTop: "1px solid #1c1c1c" }}>
                        <Typography sx={{ lineHeight: "initial", fontSize: "14pt" }}>{props.framePoints[1]}</Typography>
                    </Box>
                    <Box sx={{ backgroundColor: "secondary.superlight", width: "77px", height: "28px", gridColumn: "span 2", textAlign: "center", pt: "10px", borderBottom: "1px solid #1c1c1c" }} className="bowling-score">
        ...
        return (
            <Box sx={{ width: "118px", height: "110px", display: "flex", }}>
                <Box sx={{ mr: 0.3, backgroundColor: "#fff", width: "118px", height: "78px", display: "grid", gridTemplateColumns: "1fr 1fr 1fr" }}>
                    ...
                    <Box sx={{ backgroundColor: "secondary.superlight", width: "39px", height: "29px", textAlign: "center", pt: "10px", borderLeft: "1px solid #1c1c1c", borderBottom: "1px solid #1c1c1c", borderTop: "1px solid #1c1c1c" }}>
                        <Typography sx={{ lineHeight: "initial", fontSize: "14pt" }}>{props.framePoints[1]}</Typography>
                    </Box>
                    <Box sx={{ backgroundColor: "secondary.superlight", width: "39px", height: "29px", textAlign: "center", pt: "10px", borderLeft: "1px solid #1c1c1c", borderBottom: "1px solid #1c1c1c", borderRight: "1px solid #1c1c1c", borderTop: "1px solid #1c1c1c" }}>
                        <Typography sx={{ lineHeight: "initial", fontSize: "14pt" }}>{props.framePoints[2]}</Typography>
                    </Box>
                    <Box sx={{ backgroundColor: "secondary.superlight", width: "116px", height: "28px", gridColumn: "span 3", textAlign: "center", pt: "10px", borderBottom: "1px solid #1c1c1c", borderRight: "1px solid #1c1c1c" }} className="bowling-score">
                        <Typography sx={{ lineHeight: "initial", fontSize: "14pt" }}>{props.total}</Typography>
                    </Box>
                </Box>
            </Box>
