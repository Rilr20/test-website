...
export default function Customcard(props) {
    ...
    return (
        <Box className="card-shadow" sx={{ backgroundColor: theme => `${theme.palette.secondary.superlight}`, width: props.width, height: props.height, position: "relative", borderTopLeftRadius: "10px", borderBottomLeftRadius: "4px", borderBottomRightRadius: "4px", borderTopRightRadius: "10px", m: "auto", mt: 2, }}>
